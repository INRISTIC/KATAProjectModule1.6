...
function mobileSlider(slider, ind) {
  if (window.innerWidth <= 768 && slider.dataset.mobile === "false") {
    var _Swiper;

    swipers[ind] = new swiper__WEBPACK_IMPORTED_MODULE_1__["default"](slider, (_Swiper = {
      loop: true,
      slidesPerView: "auto",
      spaceBetween: 16
    }, _defineProperty(_Swiper, "loop", true), _defineProperty(_Swiper, "slideClass", "card"), _defineProperty(_Swiper, "pagination", {
      el: ".swiper-pagination",
      type: "bullets",
      clickable: true
    }), _defineProperty(_Swiper, "modules", [swiper__WEBPACK_IMPORTED_MODULE_1__["Navigation"], swiper__WEBPACK_IMPORTED_MODULE_1__["Pagination"]]), _Swiper));
  ...
  if (window.innerWidth > 768) {
    ...
    if (slider.classList.contains("swiper-initialized")) {
      swipers[ind].pagination.bullets.forEach(function (item) {
...
window.addEventListener("resize", function () {
  for (var i = 0; i < sliders.length; i++) {
    mobileSlider(sliders[i], i);
  }
});
var menu = document.querySelector(".menu");
var main = document.querySelector(".main");
var buttonOpen = document.querySelector(".btn--header");
var buttonClose = document.querySelector(".btn--menu");
...
var menuHelp = document.querySelector(".modal--feedback");
var menuPhone = document.querySelector(".modal--callback");
var callMain = document.querySelector(".btn--call");
var chatMain = document.querySelector(".btn--chat");
var callHeaderMain = document.querySelector(".header-btn--call");
var chatHeaderMain = document.querySelector(".header-btn--chat");
var callMainMax = document.querySelector(".container-main__btn-repair");
var chatMainMax = document.querySelector(".container-main__clear1");
var buttonForm = document.querySelector(".modal__btn-close");
var buttonCloseForm = document.querySelector(".callback-btn");
var firstInput = document.querySelector(".modal__first-input");
var secondInput = document.querySelector(".modal__second-input");
callMain.addEventListener("click", function (evt) {
  evt.preventDefault();
  menuPhone.classList.add("modal--opened");
  main.classList.add("main--modal-opened");
  firstInput.focus();
});
callHeaderMain.addEventListener("click", function (evt) {
  evt.preventDefault();
  menuPhone.classList.add("modal--opened");
  main.classList.add("main--modal-opened");
  firstInput.focus();
});
callMainMax.addEventListener("click", function (evt) {
  evt.preventDefault();
  menuPhone.classList.add("modal--opened");
  main.classList.add("main--modal-opened");
  firstInput.focus();
});
chatMain.addEventListener("click", function (evt) {
  evt.preventDefault();
  menuHelp.classList.add("modal--opened");
  main.classList.add("main--modal-opened");
  secondInput.focus();
});
chatHeaderMain.addEventListener("click", function (evt) {
  evt.preventDefault();
  menuHelp.classList.add("modal--opened");
  main.classList.add("main--modal-opened");
  secondInput.focus();
});
chatMainMax.addEventListener("click", function (evt) {
  evt.preventDefault();
  menuHelp.classList.add("modal--opened");
  main.classList.add("main--modal-opened");
  secondInput.focus();
...
buttonForm.addEventListener("click", function (evt) {
  evt.preventDefault();
  menuHelp.classList.remove("modal--opened");
  main.classList.remove("main--modal-opened");
});
buttonCloseForm.addEventListener("click", function (evt) {
  evt.preventDefault();
  menuPhone.classList.remove("modal--opened");
  main.classList.remove("main--modal-opened");
});
var heightListOne = document.querySelector(".text-height");
var buttonOne = document.querySelector(".buttonOne");
var buttonStatusOne = true;
var textButtonOne = document.querySelector(".textButtonOne");
var iconButtonOne = document.querySelector(".iconOne");
buttonOne.addEventListener("click", function (evt) {
  evt.preventDefault();

  if (buttonStatusOne) {
    heightListOne.style.height = "auto";
    textButtonOne.textContent = "Скрыть";
    iconButtonOne.style.transform = "rotate(180deg)";
    buttonStatusOne = false;
  } else {
    heightListOne.style.height = "160px";
    textButtonOne.textContent = "Показать всё";
    iconButtonOne.style.transform = "rotate(0deg)";
    buttonStatusOne = true;
  }
});
var swiperFirst = document.querySelector(".swiper-wrapper-first");
var swiperFirstButton = document.querySelector(".swiper-first-Button");
var swiperButtonStatusOne = true;
var swiperTextButtonOne = document.querySelector(".swiper-first-button-text");
var swiperIconButtonOne = document.querySelector(".swiper-second-button-icon");
swiperFirstButton.addEventListener("click", function (evt) {
  evt.preventDefault();

  if (swiperButtonStatusOne) {
    swiperFirst.style.overflow = "none";
    swiperFirst.style.height = "auto";
    swiperTextButtonOne.textContent = "Скрыть";
    swiperIconButtonOne.style.transform = "rotate(180deg)";
    swiperButtonStatusOne = false;
  } else {
    swiperFirst.style.height = "176px";
    swiperFirst.style.overflow = "hidden";
    swiperTextButtonOne.textContent = "Показать всё";
    swiperIconButtonOne.style.transform = "rotate(0deg)";
    swiperButtonStatusOne = true;
  }
});
var swiperSecond = document.querySelector(".swiper-wrapper-second");
var swiperSecondButton = document.querySelector(".swiper-second-Button");
var swiperButtonStatusTwo = true;
var swiperTextButtonTwo = document.querySelector(".swiper-second-button-text");
var swiperIconButtonTwo = document.querySelector(".swiper-second-button-icon");
swiperSecondButton.addEventListener("click", function (evt) {
  evt.preventDefault();

  if (swiperButtonStatusTwo) {
    swiperSecond.style.overflow = "none";
    swiperSecond.style.height = "auto";
    swiperTextButtonTwo.textContent = "Скрыть";
    iconButtonOne.style.transform = "rotate(180deg)";
    swiperButtonStatusTwo = false;
  } else {
    swiperSecond.style.overflow = "hidden";
    swiperSecond.style.height = "176px";
    swiperTextButtonTwo.textContent = "Показать всё";
    swiperIconButtonTwo.style.transform = "rotate(0deg)";
    swiperButtonStatusTwo = true;
  }
});
